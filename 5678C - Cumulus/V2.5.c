...
#pragma config(Motor,  port2,           shooterL,      tmotorVex393HighSpeed_MC29, openLoop)
...
task usercontrol()
{
	while(true)
	{
		...
		float xR = vexRT[Ch1];
		float yR = vexRT[Ch2];
		float shoot = vexRT[Btn7U]* 90 + vexRT[Btn7L]*85 + vexRT[Btn7R]*83 + vexRT[Btn7D]*75 + vexRT[Btn8U]*75 + vexRT[Btn8L]*70 + vexRT[Btn8R]*65 + vexRT[Btn8U]*60;//Test these numbers
		//Intake & Shooter
		if (shoot>127)
		{
			shoot = 127;
