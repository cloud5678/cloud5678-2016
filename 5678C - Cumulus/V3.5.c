...
#pragma config(Motor,  port2,           shooterL,      tmotorVex393HighSpeed_MC29, PIDControl, encoderPort, I2C_1)
...
#pragma config(Motor,  port9,           shooterR,      tmotorVex393HighSpeed_MC29, PIDControl, encoderPort, I2C_2)
