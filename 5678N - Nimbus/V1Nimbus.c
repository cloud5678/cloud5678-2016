...
#pragma config(Motor,  port2,           leftFront,    tmotorVex393_MC29, openLoop, driveRight, encoderPort, None)
#pragma config(Motor,  port3,           rightFront,     tmotorVex393_MC29, openLoop, , reversed, driveLeft, encoderPort, None)
#pragma config(Motor,  port4,           leftRear,     tmotorVex393_MC29, openLoop, driveRight, encoderPort, None)
#pragma config(Motor,  port5,           rightRear,      tmotorVex393_MC29, openLoop, reversed, driveLeft, encoderPort, None)
...
void drive(double y, double r)//Some of these might need to be made negative
{
	motor [leftFront] = (y + r);
	motor [rightFront] = (y - r);
	motor [leftRear] = (y + r);
	motor [rightRear] = (y - r);
}
