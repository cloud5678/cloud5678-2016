...
#pragma config(Motor,  port1,           shooterRBot,   tmotorVex393_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port8,           shooterLTop,   tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           shooterRTop,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          shooterLBot,   tmotorVex393_HBridge, openLoop)
...
task autonomous()
{
	...
	motor[shooterLTop] = motor[shooterRTop] = motor[shooterRBot] = motor[shooterLBot] = 127;
	drive(0);
	wait1Msec(3000);

	motor[shooterLTop] = motor[shooterRTop] = motor[shooterRBot] = motor[shooterLBot] = 0;
	drive(0);
	while(true)
	{
		clearLCDLine(0);
...
{
motor[shooterLTop] = motor[shooterRTop] = motor[shooterRBot] = motor[shooterLBot] = x;
}
